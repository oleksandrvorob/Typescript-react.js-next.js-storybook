...
export class UsersDrawRequestViewAddLoanStatus1598466664003 implements MigrationInterface {
  name = 'UsersDrawRequestViewAddLoanStatus1598466664003'
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP VIEW IF EXISTS "public"."users_draw_request_view"`)
    ...
    SELECT
      ...
      t5.approved_amount,
      t5.approved_date,
      t5.status as draw_request_status,
      t1.user_id,
      t2.id as company_id,
      t2.company_name,
      t4.lid,
